...
const toggleRootButton = document.getElementById("toggleRootButton");
const rootDiv = document.getElementById("root");
let isRootVisible = true;

toggleRootButton.addEventListener("click", function () {
  isRootVisible = !isRootVisible;
  rootDiv.style.display = isRootVisible ? "block" : "none";
  toggleRootButton.textContent = isRootVisible
    ? "Hide Details"
    : "Show Details";
});

rootDiv.style.display = "block";
toggleRootButton.textContent = "Hide Details";
